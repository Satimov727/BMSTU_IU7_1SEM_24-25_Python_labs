# Лимарев Степан ИУ7-11Б. Программа добавляет элемент в заданное место списка (по индексу) с использованием любых средств Python.
...
if user_index >= len(lst) or user_index < 0 :
    ...
    lst.insert(user_index, user_value)
